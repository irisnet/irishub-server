...
// 2018-05-31 11:11:43.160332 +0800 CST m=+0.255893236
...
var doc = `{
    ...
    "info": {
        ...
        "contact": {},
        "license": {
            "name": "API Spec Document",
            "url": "https://github.com/kaifei-bianjie/share/blob/master/api_spec.md"
        },
        "version": "0.1.0"
    },
    ...
    "paths": {
        ...
        "/txs": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "generate response data error, please see result",
                        "schema": {
                            "type": "string"
                        }
                    }
